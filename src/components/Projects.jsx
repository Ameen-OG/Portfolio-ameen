...
const projectsData = [
  ...
  { id: 2, title: 'Role Based Backend Server', description: 'Secure backend API with JWT authentication, role-based access control, and product management features.', category: 'backend', image: '/Rolebased.png', tech: ['Node.js', 'Express.js', 'MongoDB', 'JWT', 'bcrypt'], github: '#', demo: '#', features: ['User signup & login', 'JWT authentication', 'Admin & customer roles', 'Protected admin routes', 'CRUD products API', 'Public product endpoints'] },
