...
const projectsData = [
  { id: 1, title: 'Cowin Site', category: 'frontend', image: '/public/cowin.png', desc: 'Same design the real cowin site', tech: ['Boostrap' ,'CSS'], github: '#', demo: '#', features: ['Live charts', 'Dark mode'] },
  { id: 2, title: 'Role Based Backend Server', category: 'backend', image: '/public/Rolebased.png', tech: ['Node.js', 'Express.js', 'MongoDB', 'JWT', 'bcrypt'], github: '#', demo: '#', features: [ 'User signup & login', 'JWT authentication','Admin & customer roles','Protected admin routes','CRUD products API','Public product endpoints' ] },
  { id: 3, title: 'E-commerce', category: 'fullstack', image: '/public/ecommerce.png', desc: 'Full-stack eCommerce application with authentication, product management, cart, and order features.', tech: ['React.js', 'tailwind', 'PostgreSQL'], github: '#', demo: '#', features: ['Realtime updates', 'Drag & drop'] },
